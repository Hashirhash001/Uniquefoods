...
<style>
    * { margin:0; padding:0; box-sizing:border-box; }
    ...
    .s-cell { display:table-cell; text-align:center; background:#f9fafb; border:1px solid #e5e7eb; border-radius:6px; padding:10px; width:25%; }
...
<body>
    ...
    <div class="addr-row">
        ...
        <div class="addr-box" style="text-align:right;">
            ...
            <p>
                ...
                {{ config('admin.address', '') }}<br>
                {{ config('admin.email', config('mail.from.address', '')) }}
            </p>
        </div>
    </div>
    ...
    <div class="footer">
        <p>Thank you for your order! For questions, contact {{ config('mail.from.address') }}</p>
        <p style="margin-top:4px;">© {{ now()->year }} {{ config('app.name') }}. All rights reserved.</p>
    </div>
