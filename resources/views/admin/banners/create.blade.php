...
@push('styles')
<style>
    /* Reuse ALL styles from product form */
    * {
                ...
                <div class="form-section">
                    ...
                    <div class="row g-4">
                        <div class="col-md-8">
                            ...
                            <input type="text" name="title" class="form-control" placeholder="e.g., Don't miss our amazing grocery deals" required>
                        ...
                        <div class="col-md-12">
                            ...
                            <input type="text" name="subtitle" class="form-control" placeholder="e.g., Get up to 30% off on your first ₹150 purchase">
                            <small class="text-danger error-subtitle"></small>
                        </div>

                        <div class="col-md-12">
                            <label class="form-label">Description</label>
                            <textarea name="description" class="form-control" rows="3" placeholder="We have prepared special discounts for you on grocery products..."></textarea>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="button_text" class="form-control" value="Shop Now" placeholder="Shop Now">
                            <small class="text-danger error-button_text"></small>
                        </div>

                        <div class="col-md-6">
                            <label class="form-label">Button Link</label>
                            <input type="text" name="button_link" class="form-control" placeholder="/shop or #products">
                    ...
                    <div class="row g-4">
                        <div class="col-md-6">
                            ...
                            <div class="color-input-group">
                                ...
                                <input type="text" name="background_color" id="bgColorText" class="form-control" value="#f8f9fa">
                            </div>
