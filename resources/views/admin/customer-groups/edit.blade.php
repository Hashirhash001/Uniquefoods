    ...
    <div class="card product-card">
        <div class="card-header">
            <h4>
                ...
                Edit Customer Group: {{ $customerGroup->name }}
            </h4>
        </div>
        ...
        <div class="card-body">
            <form id="groupForm">
                    ...
                    <div class="row g-4">
                        <div class="col-md-8">
                            ...
                            <input type="text" name="name" class="form-control"
                                   ...
                                   placeholder="e.g., Gold Members, Monthly Buyers">
                        ...
                        <div class="col-md-4">
                            ...
                            <select name="is_active" class="form-select">
                                <option value="1" {{ old('is_active', $customerGroup->is_active) == 1 ? 'selected' : '' }}>Active</option>
                                <option value="0" {{ old('is_active', $customerGroup->is_active) == 0 ? 'selected' : '' }}>Inactive</option>
                            </select>
                        ...
                        <div class="col-md-12">
                            ...
                            <textarea name="description" class="form-control" rows="3"
                                      placeholder="Brief description about this customer group...">{{ old('description', $customerGroup->description) }}</textarea>
                ...
                <div class="form-section">
                    ...
                    @php
                        $assignedCustomerIds = $customerGroup->users->pluck('id')->toArray();
                    @endphp
                    ...
                    <div class="customer-selection-wrapper">
                        ...
                        <div class="customer-stats">
                            ...
                            <span>
                                ...
                                Selected: <strong class="selected-count" id="selectedCount">{{ count($assignedCustomerIds) }}</strong>
                            </span>
                        </div>

                        <div class="customer-select" id="customerList">
                            @forelse($customers as $customer)
                            <div class="customer-item {{ in_array($customer->id, $assignedCustomerIds) ? 'selected' : '' }}"
                    ...
                    <small class="form-text mt-2">
                        ...
                        Tip: Changes to customer assignments take effect immediately
                    </small>
...
$(document).ready(function() {
    ...
    $('#groupForm').submit(function(e) {
        ...
        $.ajax({
            url: "{{ route('admin.customer-groups.update', $customerGroup) }}",
            method: "POST",
            data: $(this).serialize(),
            headers: {
